...
const SpaceCard = ({ image }: { image: SpaceEntity }) => {
  ...
  return (
    <>
      ...
      <Card className="w-full gap-2 h-full flex justify-between flex-col text-base sm:text-lg md:text-xl hover:bg-primary/2 hover:shadow-lg transition-all duration-300">
